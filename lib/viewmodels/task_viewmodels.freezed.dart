...
class __$$IdleImplCopyWithImpl<$Res>
    extends _$TaskStateCopyWithImpl<$Res, _$IdleImpl>
...
abstract class Idle implements TaskState {
...
abstract class Loading implements TaskState {
...
class _$DataImpl implements Data {
  const _$DataImpl(final List<Task> tasks) : _tasks = tasks;
...
abstract class Data implements TaskState {
  const factory Data(final List<Task> tasks) = _$DataImpl;
...
abstract class Error implements TaskState {
